...
{
    public interface IDuration : IDimension, IDimensionSupportsPerExtension
    {
    ...
    public readonly struct DurationDouble : IEquatable<DurationDouble>
    {
        ...
        internal DurationDouble(double valueAsDouble, Length1DUnitOfMeasure unitOfMeasure)
        {
        ...
        bool IEquatable<DurationDouble>.Equals(DurationDouble other) => EqualityComparer<double>.Default.Equals(ValueAsDouble, other.ValueAsDouble) && EqualityComparer<Length1DUnitOfMeasure>.Default.Equals(UnitOfMeasure, other.UnitOfMeasure);
    ...
    {
        #region Constructors
        public Duration(TDataType length) => DurationValue = length;

        public Duration(Duration<TUnitOfMeasure, TDataType> length) => DurationValue = length.DurationValue;
        
        public Duration(DurationDouble lengthToConvertFrom) => DurationValue = GenericOperatorMath<TDataType>.ConvertFromDouble(lengthToConvertFrom.ValueAsDouble * lengthToConvertFrom.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));
        ...
        Length1DUnitOfMeasure IDuration.UnitOfMeasure => UnitOfMeasure;
        #endregion
        ...
        public static explicit operator TDataType(Length<TUnitOfMeasure, TDataType> length) => length.DurationValue;

        public static implicit operator DurationDouble(Length<TUnitOfMeasure, TDataType> length) => new DurationDouble(length.ValueAsDouble, length.UnitOfMeasure);

        public static implicit operator DurationDouble<TUnitOfMeasure>(Length<TUnitOfMeasure, TDataType> length) => new DurationDouble<TUnitOfMeasure>(length.ValueAsDouble);
        #endregion

        #region + Operators
        public static Length<TUnitOfMeasure, TDataType> operator +(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Add(length1.DurationValue, length2.DurationValue));

        public static Length<TUnitOfMeasure, double> operator +(Length<TUnitOfMeasure, TDataType> length1, DurationDouble length2) => length1.ValueAsDouble + (length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));
        #endregion

        #region - Operators
        public static Length<TUnitOfMeasure, TDataType> operator -(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Subtract(length1.DurationValue, length2.DurationValue));

        public static Length<TUnitOfMeasure, double> operator -(Length<TUnitOfMeasure, TDataType> length1, DurationDouble length2) => length1.ValueAsDouble - (length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));
        #endregion

        #region * Operators
        public static Length<TUnitOfMeasure, TDataType> operator *(TDataType length1, Length<TUnitOfMeasure, TDataType> length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Multiply(length1, length2.DurationValue));

        public static Length<TUnitOfMeasure, TDataType> operator *(Length<TUnitOfMeasure, TDataType> length1, TDataType length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Multiply(length1.DurationValue, length2));

        public static Area<TUnitOfMeasure, TDataType> operator *(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.Multiply(length1.DurationValue, length2.DurationValue);

        public static Area<TUnitOfMeasure, double> operator *(Length<TUnitOfMeasure, TDataType> length1, DurationDouble length2) => length1.ValueAsDouble * (length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));

        public static Volume<TUnitOfMeasure, TDataType> operator *(Length<TUnitOfMeasure, TDataType> length1, Area<TUnitOfMeasure, TDataType> area2) => GenericOperatorMath<TDataType>.Multiply(length1.DurationValue, area2.AreaValue);

        public static Volume<TUnitOfMeasure, TDataType> operator *(Area<TUnitOfMeasure, TDataType> area1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.Multiply(area1.AreaValue, length2.DurationValue);
        ...
        public static double operator /(Length<TUnitOfMeasure, TDataType> length1, DurationDouble length2) => length1.ValueAsDouble / length2.ValueAsDouble;
        ...
        #region == Operators
        public static bool operator ==(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => EqualityComparer<TDataType>.Default.Equals(length1.DurationValue, length2.DurationValue);

        public static bool operator ==(Length<TUnitOfMeasure, TDataType> length1, DurationDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) == 0;
        #endregion
        ...
        #region > Operators
        public static bool operator >(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.GreaterThan(length1.DurationValue, length2.DurationValue);

        public static bool operator >(Length<TUnitOfMeasure, TDataType> length1, DurationDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) > 0;
        #endregion

        #region < Operators
        public static bool operator <(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.LessThan(length1.DurationValue, length2.DurationValue);

        public static bool operator <(Length<TUnitOfMeasure, TDataType> length1, DurationDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) < 0;
        #endregion

        #region >= Operators
        public static bool operator >=(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.GreaterThanOrEqualTo(length1.DurationValue, length2.DurationValue);

        public static bool operator >=(Length<TUnitOfMeasure, TDataType> length1, DurationDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) >= 0;
        #endregion

        #region <= Operators
        public static bool operator <=(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.LessThanOrEqualTo(length1.DurationValue, length2.DurationValue);

        public static bool operator <=(Length<TUnitOfMeasure, TDataType> length1, DurationDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) <= 0;
        #endregion

        #region squared, cubed
        public Area<TUnitOfMeasure, TDataType> Squared => GenericOperatorMath<TDataType>.Multiply(DurationValue, DurationValue);

        public Volume<TUnitOfMeasure, TDataType> Cubed => GenericOperatorMath<TDataType>.Multiply(GenericOperatorMath<TDataType>.Multiply(DurationValue, DurationValue), DurationValue);
        #endregion
        ...
        #region Equals
        public override bool Equals(object? obj) => obj != null && obj is Length<TUnitOfMeasure, TDataType> o && EqualityComparer<TDataType>.Default.Equals(DurationValue, o.DurationValue);

        bool IEquatable<Length<TUnitOfMeasure, TDataType>>.Equals(Length<TUnitOfMeasure, TDataType> other) => EqualityComparer<TDataType>.Default.Equals(DurationValue, other.DurationValue);
        #endregion
...
namespace NGenericDimensions.Extensions
{
    public static class LengthExtensionMethods
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Always)]
        public static TDataType? DurationValue<TUnitOfMeasure, TDataType>(this Length<TUnitOfMeasure, TDataType>? length)
            where TUnitOfMeasure : Length1DUnitOfMeasure, IDefinedUnitOfMeasure
            where TDataType : struct, IComparable, IFormattable, IComparable<TDataType>, IEquatable<TDataType> => length?.DurationValue;
        #endregion
    }
}
*/
