...
namespace NGenericDimensions
{
    ...
    public readonly struct MassDouble : IEquatable<MassDouble>
    {
        ...
        internal MassDouble(double valueAsDouble, Length1DUnitOfMeasure unitOfMeasure)
        {
        ...
        bool IEquatable<MassDouble>.Equals(MassDouble other) => EqualityComparer<double>.Default.Equals(ValueAsDouble, other.ValueAsDouble) && EqualityComparer<Length1DUnitOfMeasure>.Default.Equals(UnitOfMeasure, other.UnitOfMeasure);
    ...
    {
        #region Constructors
        public Mass(TDataType length) => MassValue = length;

        public Mass(Mass<TUnitOfMeasure, TDataType> length) => MassValue = length.MassValue;
        
        public Mass(MassDouble lengthToConvertFrom) => MassValue = GenericOperatorMath<TDataType>.ConvertFromDouble(lengthToConvertFrom.ValueAsDouble * lengthToConvertFrom.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));
        ...
        Length1DUnitOfMeasure IMass.UnitOfMeasure => UnitOfMeasure;
        #endregion
        ...
        public static explicit operator TDataType(Length<TUnitOfMeasure, TDataType> length) => length.MassValue;

        public static implicit operator MassDouble(Length<TUnitOfMeasure, TDataType> length) => new MassDouble(length.ValueAsDouble, length.UnitOfMeasure);

        public static implicit operator MassDouble<TUnitOfMeasure>(Length<TUnitOfMeasure, TDataType> length) => new MassDouble<TUnitOfMeasure>(length.ValueAsDouble);
        #endregion

        #region + Operators
        public static Length<TUnitOfMeasure, TDataType> operator +(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Add(length1.MassValue, length2.MassValue));

        public static Length<TUnitOfMeasure, double> operator +(Length<TUnitOfMeasure, TDataType> length1, MassDouble length2) => length1.ValueAsDouble + (length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));
        #endregion

        #region - Operators
        public static Length<TUnitOfMeasure, TDataType> operator -(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Subtract(length1.MassValue, length2.MassValue));

        public static Length<TUnitOfMeasure, double> operator -(Length<TUnitOfMeasure, TDataType> length1, MassDouble length2) => length1.ValueAsDouble - (length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));
        #endregion

        #region * Operators
        public static Length<TUnitOfMeasure, TDataType> operator *(TDataType length1, Length<TUnitOfMeasure, TDataType> length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Multiply(length1, length2.MassValue));

        public static Length<TUnitOfMeasure, TDataType> operator *(Length<TUnitOfMeasure, TDataType> length1, TDataType length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Multiply(length1.MassValue, length2));

        public static Area<TUnitOfMeasure, TDataType> operator *(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.Multiply(length1.MassValue, length2.MassValue);

        public static Area<TUnitOfMeasure, double> operator *(Length<TUnitOfMeasure, TDataType> length1, MassDouble length2) => length1.ValueAsDouble * (length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));

        public static Volume<TUnitOfMeasure, TDataType> operator *(Length<TUnitOfMeasure, TDataType> length1, Area<TUnitOfMeasure, TDataType> area2) => GenericOperatorMath<TDataType>.Multiply(length1.MassValue, area2.AreaValue);

        public static Volume<TUnitOfMeasure, TDataType> operator *(Area<TUnitOfMeasure, TDataType> area1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.Multiply(area1.AreaValue, length2.MassValue);
        ...
        public static double operator /(Length<TUnitOfMeasure, TDataType> length1, MassDouble length2) => length1.ValueAsDouble / length2.ValueAsDouble;
        ...
        #region == Operators
        public static bool operator ==(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => EqualityComparer<TDataType>.Default.Equals(length1.MassValue, length2.MassValue);

        public static bool operator ==(Length<TUnitOfMeasure, TDataType> length1, MassDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) == 0;
        #endregion
        ...
        #region > Operators
        public static bool operator >(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.GreaterThan(length1.MassValue, length2.MassValue);

        public static bool operator >(Length<TUnitOfMeasure, TDataType> length1, MassDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) > 0;
        #endregion

        #region < Operators
        public static bool operator <(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.LessThan(length1.MassValue, length2.MassValue);

        public static bool operator <(Length<TUnitOfMeasure, TDataType> length1, MassDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) < 0;
        #endregion

        #region >= Operators
        public static bool operator >=(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.GreaterThanOrEqualTo(length1.MassValue, length2.MassValue);

        public static bool operator >=(Length<TUnitOfMeasure, TDataType> length1, MassDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) >= 0;
        #endregion

        #region <= Operators
        public static bool operator <=(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.LessThanOrEqualTo(length1.MassValue, length2.MassValue);

        public static bool operator <=(Length<TUnitOfMeasure, TDataType> length1, MassDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) <= 0;
        #endregion

        #region squared, cubed
        public Area<TUnitOfMeasure, TDataType> Squared => GenericOperatorMath<TDataType>.Multiply(MassValue, MassValue);

        public Volume<TUnitOfMeasure, TDataType> Cubed => GenericOperatorMath<TDataType>.Multiply(GenericOperatorMath<TDataType>.Multiply(MassValue, MassValue), MassValue);
        #endregion
        ...
        #region Equals
        public override bool Equals(object? obj) => obj != null && obj is Length<TUnitOfMeasure, TDataType> o && EqualityComparer<TDataType>.Default.Equals(MassValue, o.MassValue);

        bool IEquatable<Length<TUnitOfMeasure, TDataType>>.Equals(Length<TUnitOfMeasure, TDataType> other) => EqualityComparer<TDataType>.Default.Equals(MassValue, other.MassValue);
        #endregion
...
namespace NGenericDimensions.Extensions
{
    public static class LengthExtensionMethods
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Always)]
        public static TDataType? MassValue<TUnitOfMeasure, TDataType>(this Length<TUnitOfMeasure, TDataType>? length)
            where TUnitOfMeasure : Length1DUnitOfMeasure, IDefinedUnitOfMeasure
            where TDataType : struct, IComparable, IFormattable, IComparable<TDataType>, IEquatable<TDataType> => length?.MassValue;
        #endregion
    }
}
*/
