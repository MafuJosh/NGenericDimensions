...
{
    public interface IVolume : IDimension, IDimensionSupportsPerExtension
    {
    ...
    public readonly struct VolumeDouble : IEquatable<VolumeDouble>
    {
        ...
        internal VolumeDouble(double valueAsDouble, Length1DUnitOfMeasure unitOfMeasure)
        {
        ...
        bool IEquatable<VolumeDouble>.Equals(VolumeDouble other) => EqualityComparer<double>.Default.Equals(ValueAsDouble, other.ValueAsDouble) && EqualityComparer<Length1DUnitOfMeasure>.Default.Equals(UnitOfMeasure, other.UnitOfMeasure);
    ...
    {
        #region Constructors
        public Volume(TDataType length) => VolumeValue = length;

        public Volume(Volume<TUnitOfMeasure, TDataType> length) => VolumeValue = length.VolumeValue;
        
        public Volume(VolumeDouble lengthToConvertFrom) => VolumeValue = GenericOperatorMath<TDataType>.ConvertFromDouble(lengthToConvertFrom.ValueAsDouble * lengthToConvertFrom.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));
        ...
        Length1DUnitOfMeasure IVolume.UnitOfMeasure => UnitOfMeasure;
        #endregion
        ...
        public static explicit operator TDataType(Length<TUnitOfMeasure, TDataType> length) => length.VolumeValue;

        public static implicit operator VolumeDouble(Length<TUnitOfMeasure, TDataType> length) => new VolumeDouble(length.ValueAsDouble, length.UnitOfMeasure);

        public static implicit operator VolumeDouble<TUnitOfMeasure>(Length<TUnitOfMeasure, TDataType> length) => new VolumeDouble<TUnitOfMeasure>(length.ValueAsDouble);
        #endregion

        #region + Operators
        public static Length<TUnitOfMeasure, TDataType> operator +(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Add(length1.VolumeValue, length2.VolumeValue));

        public static Length<TUnitOfMeasure, double> operator +(Length<TUnitOfMeasure, TDataType> length1, VolumeDouble length2) => length1.ValueAsDouble + (length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));
        #endregion

        #region - Operators
        public static Length<TUnitOfMeasure, TDataType> operator -(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Subtract(length1.VolumeValue, length2.VolumeValue));

        public static Length<TUnitOfMeasure, double> operator -(Length<TUnitOfMeasure, TDataType> length1, VolumeDouble length2) => length1.ValueAsDouble - (length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));
        #endregion

        #region * Operators
        public static Length<TUnitOfMeasure, TDataType> operator *(TDataType length1, Length<TUnitOfMeasure, TDataType> length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Multiply(length1, length2.VolumeValue));

        public static Length<TUnitOfMeasure, TDataType> operator *(Length<TUnitOfMeasure, TDataType> length1, TDataType length2) => new Length<TUnitOfMeasure, TDataType>(GenericOperatorMath<TDataType>.Multiply(length1.VolumeValue, length2));

        public static Area<TUnitOfMeasure, TDataType> operator *(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.Multiply(length1.VolumeValue, length2.VolumeValue);

        public static Area<TUnitOfMeasure, double> operator *(Length<TUnitOfMeasure, TDataType> length1, VolumeDouble length2) => length1.ValueAsDouble * (length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1));

        public static Volume<TUnitOfMeasure, TDataType> operator *(Length<TUnitOfMeasure, TDataType> length1, Area<TUnitOfMeasure, TDataType> area2) => GenericOperatorMath<TDataType>.Multiply(length1.VolumeValue, area2.AreaValue);

        public static Volume<TUnitOfMeasure, TDataType> operator *(Area<TUnitOfMeasure, TDataType> area1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.Multiply(area1.AreaValue, length2.VolumeValue);
        ...
        public static double operator /(Length<TUnitOfMeasure, TDataType> length1, VolumeDouble length2) => length1.ValueAsDouble / length2.ValueAsDouble;
        ...
        #region == Operators
        public static bool operator ==(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => EqualityComparer<TDataType>.Default.Equals(length1.VolumeValue, length2.VolumeValue);

        public static bool operator ==(Length<TUnitOfMeasure, TDataType> length1, VolumeDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) == 0;
        #endregion
        ...
        #region > Operators
        public static bool operator >(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.GreaterThan(length1.VolumeValue, length2.VolumeValue);

        public static bool operator >(Length<TUnitOfMeasure, TDataType> length1, VolumeDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) > 0;
        #endregion

        #region < Operators
        public static bool operator <(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.LessThan(length1.VolumeValue, length2.VolumeValue);

        public static bool operator <(Length<TUnitOfMeasure, TDataType> length1, VolumeDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) < 0;
        #endregion

        #region >= Operators
        public static bool operator >=(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.GreaterThanOrEqualTo(length1.VolumeValue, length2.VolumeValue);

        public static bool operator >=(Length<TUnitOfMeasure, TDataType> length1, VolumeDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) >= 0;
        #endregion

        #region <= Operators
        public static bool operator <=(Length<TUnitOfMeasure, TDataType> length1, Length<TUnitOfMeasure, TDataType> length2) => GenericOperatorMath<TDataType>.LessThanOrEqualTo(length1.VolumeValue, length2.VolumeValue);

        public static bool operator <=(Length<TUnitOfMeasure, TDataType> length1, VolumeDouble length2) => length1.ValueAsDouble.CompareTo(length2.ValueAsDouble * length2.UnitOfMeasure.GetCompleteMultiplier<TUnitOfMeasure>(1)) <= 0;
        #endregion

        #region squared, cubed
        public Area<TUnitOfMeasure, TDataType> Squared => GenericOperatorMath<TDataType>.Multiply(VolumeValue, VolumeValue);

        public Volume<TUnitOfMeasure, TDataType> Cubed => GenericOperatorMath<TDataType>.Multiply(GenericOperatorMath<TDataType>.Multiply(VolumeValue, VolumeValue), VolumeValue);
        #endregion

        #region ToString
        public override string ToString() => UnitOfMeasure.ToString(VolumeValue, null, null);

        public string ToString(string? format, IFormatProvider? formatProvider) => UnitOfMeasure.ToString(VolumeValue, format, formatProvider);
        #endregion

        #region Equals
        public override bool Equals(object? obj) => obj != null && obj is Length<TUnitOfMeasure, TDataType> o && EqualityComparer<TDataType>.Default.Equals(VolumeValue, o.VolumeValue);

        bool IEquatable<Length<TUnitOfMeasure, TDataType>>.Equals(Length<TUnitOfMeasure, TDataType> other) => EqualityComparer<TDataType>.Default.Equals(VolumeValue, other.VolumeValue);
        #endregion
...
namespace NGenericDimensions.Extensions
{
    public static class LengthExtensionMethods
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Always)]
        public static TDataType? VolumeValue<TUnitOfMeasure, TDataType>(this Length<TUnitOfMeasure, TDataType>? length)
            where TUnitOfMeasure : Length1DUnitOfMeasure, IDefinedUnitOfMeasure
            where TDataType : struct, IComparable, IFormattable, IComparable<TDataType>, IEquatable<TDataType> => length?.VolumeValue;
        #endregion
    }
}
*/
